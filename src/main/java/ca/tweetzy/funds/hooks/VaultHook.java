...
public final class VaultHook implements Economy {
	...
	public String format(double amount) {
		return String.format("%s %s", String.format("%,.2f", amount), amount == 1D ? Funds.getCurrencyManager().getVaultOrFirst().getSingularFormat() : Funds.getCurrencyManager().getVaultOrFirst().getPluralFormat());
	}
