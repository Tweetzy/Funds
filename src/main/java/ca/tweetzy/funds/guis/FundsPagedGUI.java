...
public abstract class FundsPagedGUI<T> extends PagedGUI<T> {

	public FundsPagedGUI(Gui parent, @NonNull String title, int rows, @NonNull List<T> items) {
		super(parent, title, rows, items);

	}

	public FundsPagedGUI(@NonNull String title, int rows, @NonNull List<T> items) {
